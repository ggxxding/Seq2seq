...
class NMTModel(object):
    ...
    def forward(self, src_input, src_size, trg_input, trg_label, trg_size):
        ...
        with tf.compat.v1.variable_scope("decoder"):
            dec_outputs, _ = tf.compat.v1.nn.dynamic_rnn(self.dec_cell, trg_emb, trg_size, initial_state=enc_state)
        ...
        # 控制梯度大小，定义优化方法和训练步骤。
        grads = tf.gradients(cost / tf.compat.v1.to_float(batch_size), trainable_variables)
